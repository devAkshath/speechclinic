...
export default function Navbar() {
    ...
    return (
        <nav className="max-w-screen-xl mx-auto p-8 bg-transparent w-full relative">
            ...
            <div
                ref={mobileMenuRef}
                className={`fixed top-0 right-0 h-full w-full sm:w-3/4 sm:max-w-xs bg-white p-6 transform ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 ease-in-out z-100`}
            >
                ...
                <ul className="space-y-4 mt-6 py-5 text-gray-800">
                    <li className="text-lg font-bold"><Link href="./" onClick={handleMobileLinkClick}>Home</Link></li>
                    <li className="text-lg font-bold"><Link href="#" onClick={handleMobileLinkClick}>About</Link></li>
                    ...
                    <li className="text-lg font-bold">
                        <details className="group">
                            ...
                            <ul className="pl-4 mt-2 space-y-2 text-sm text-gray-700">
                                <li><Link href="#" onClick={handleMobileLinkClick}>Speech Therapy</Link></li>
                                <li><Link href="#" onClick={handleMobileLinkClick}>Occupational Therapy</Link></li>
                            </ul>
                        </details>
                    </li>
                    ...
                    <li className="text-lg font-bold">
                        <details className="group">
                            ...
                            <ul className="pl-4 mt-2 space-y-2 text-sm text-gray-700">
                                <li><Link href="#" onClick={handleMobileLinkClick}>Product A</Link></li>
                                <li><Link href="#" onClick={handleMobileLinkClick}>Product B</Link></li>
                            </ul>
                        </details>
                    </li>

                    <li className="text-lg font-bold"><Link href="/team" onClick={handleMobileLinkClick}>Teams</Link></li>
                    <li className="text-lg font-bold"><Link href="#" onClick={handleMobileLinkClick}>Contact</Link></li>
                </ul>
            </div>
