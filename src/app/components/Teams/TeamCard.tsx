              ...
              <div className="flex-1 text-gray-700 space-y-4">
                ...
                <div className="text-sm md:text-base space-y-1">
                  ...
                  <ul className="list-disc list-inside pl-2 space-y-1 text-gray-700">
                    <li> PROMPT</li>
                    <li> OPT LEVEL 3</li>
                    <li> Sensory Motor Apraxia of Speech</li>
                    <li> DIR FLOOR TIME</li>
                    <li> Feeding Therapy</li>
                    <li> Assessor - ADOS 2</li>
                    <li> Nuffield Dyspraxia Program</li>
                    <li> Sensory Integration Level 2</li>
                    <li> Certified Sensory Speech Therapist from Inside Out</li>
                    <li> Trained in Gestalt Processing and Hanen Approach</li>
                    <li> Therapeutic Listening & Movement Program</li>
                  </ul>
                </div>
              </div>
            </div>
