...
const services: Service[] = [
    {
        ...
        description: "The K-SLP methods shape a child's best approximation of words toward full adult forms. It follows motor learning principles to improve speech movement patterns. The goal is to make speech more natural, intelligible, and effective for everyday interactions.",
    ...
    },
    {
        ...
        description: "Oral Placement Therapy (OPT) is a specialized speech therapy approach which enhances oral motor skills for speech and feeding by using tactile and proprioceptive inputs. It helps improve speech clarity and feeding in individuals with conditions like apraxia, dysarthria, and expressive language delays.",
        heroimage: "/galleryimage3.jpg",
        galleryimages: [
            "/galleryimage3.jpg",
            "/galleryimage3.jpg",
    ...
    },
    {
        ...
        description: "PROMPT FOR RESTRUCTURING ORALMUSCULAR PHONETIC TARGETS is an evidence-based technique where oral structures are guided using clinician hands to produce sounds or words. It helps in refining oral movements to plan better speech production.",
        heroimage: "/galleryimage3.jpg",
        galleryimages: [
            "/galleryimage3.jpg",
    ...
    },
    {
        ...
        description: "Gestalt language processing is a therapeutic approach that views language as a whole, rather than focusing on individual words or isolated phrases. This process encourages individuals to understand and use language in its natural, integrated form, where communication is more than just the sum of its parts. In the context of Gestalt Language Therapy (GLT), this approach helps individuals particularly those with autism or developmental language disorders connect emotionally, socially, and cognitively through speech.",
        heroimage: "/galleryimage3.jpg",
        galleryimages: [
            "/galleryimage3.jpg",
            // "/images/tailwind-2.jpg",
...

    {
        ...
        description: "Speech sound disorders are a group of communication challenges in which individuals have difficulty producing sounds correctly, making it hard for others to understand their speech. These disorders can be categorized into two main types: articulation disorders and phonological disorders",
        heroimage: "/galleryimage3.jpg",
        galleryimages: [
            "/galleryimage3.jpg",
            "/galleryimage3.jpg",
...

    {
        slug: "makaton",
        title: "Makaton",
        description: "Makaton is a language program that uses Speech, Signs and Symbols for basic communication. It helps to develop language skills and facilitate social interaction.",
        heroimage: "/galleryimage3.jpg",
        galleryimages: [
            "/galleryimage3.jpg",
            // "/images/tailwind-2.jpg",
    ...
    },
    {
        ...
        description: "DIR is a Developmental, Individual-differences, and Relationships-based model and DIR Floortime applies this theoretical framework in the therapy process.",
        heroimage: "/galleryimage3.jpg",
        galleryimages: [
            "/galleryimage3.jpg",
            // "/images/tailwind-2.jpg",
    ...
    },
    {
        ...
        description: "The sensory motor approach encompasses Oral Placement Therapy (OPT) activities that utilize tactile modality in conjunction with auditory and visual modalities.",
        heroimage: "/galleryimage3.jpg",
        galleryimages: [
            "/galleryimage3.jpg",
            // "/images/tailwind-2.jpg",
    ...
    },
    {
        ...
        description: "At The Speech Clinic, we provide specialized language booster clubs offering a fun, language rich and interactive environment for our children. These clubs enhance the child's speech & language development and provide relevant opportunities for them to communicate.",
        heroimage: "/galleryimage3.jpg",
        galleryimages: [
            "/galleryimage3.jpg",
