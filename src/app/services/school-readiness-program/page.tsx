                                  ...
                                  hover:after:-translate-x-2 hover:after:-translate-y-2">
                                    ...
                                    <div className="relative z-10 my-6">
                                        <div>
                                            ...
                                            <p>The program ensures that children can participate, learn, and thrive in school at their own pace, fostering both academic and personal growth. To assess each child&lsquo;s readiness and developmental progress, we use specialized tools like the MDPS Tool and VB-MAPP. These assessments help evaluate each child&lsquo;s developmental needs, ensuring they are prepared for their educational journey.</p>
                                            ...
                                            <div className="bg-white p-6 rounded-xl shadow-md my-3">
